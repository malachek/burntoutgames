...
const FONTS =
  'https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Roboto:wght@400;500;700&family=Roboto+Condensed:wght@700&display=swap';
...
function footer(site) {
  ...
  // Everything that isn't one of the three priority calls to action.
    ...
    <div class="site-footer__grid">
      ...
      <div>
        ...
        <div class="follow-ctas">
          ...
          <a class="btn btn--ghost btn--sm" href="${esc(site.linktreeUrl)}" target="_blank" rel="noopener noreferrer">All our links</a>
        </div>
        <ul class="small" style="margin-top:var(--s-5);display:flex;flex-wrap:wrap;gap:var(--s-2) var(--s-4)">
          ...
          <li style="margin-top:0"><a href="${esc(community)}" target="_blank" rel="noopener noreferrer">Discord</a></li>
        </ul>
      </div>
    </div>
  ...
  <div class="wrap">
    <div class="grid grid--2" style="gap:var(--s-8);align-items:center">
      ...
      <figure class="figure">
        ...
        <figcaption class="small muted">The Burnt Out Games team and EXO contributors.</figcaption>
      </figure>
    </div>
  </div>
</section>
...
${team.length ? `<section class="section on-firewood" id="team">
  <div class="wrap">
    <h2 class="visually-hidden">The team</h2>
    <ul class="team-grid">
      ${team.map((p) => `<li class="person reveal">
        ...
        ${p.url ? `<p class="small" style="margin-top:var(--s-2)"><a href="${esc(p.url)}" target="_blank" rel="noopener noreferrer">Profile</a></p>` : ''}
      </li>`).join('\n      ')}
    </ul>
    <div class="section-head" style="margin:var(--s-7) 0 0">
      <span class="eyebrow">The team</span>
      <p class="lead">${esc(site.teamBlurb || '')}</p>
    </div>
  </div>
</section>` : ''}
  ...
  <div class="wrap">
    <div class="grid grid--2" style="gap:var(--s-8);align-items:start">
      ...
      <div class="copy-block stack-sm">
        ...
        <ul class="link-list">
          <li><a href="${esc(community)}" target="_blank" rel="noopener noreferrer">Discord: updates and playtests</a></li>
