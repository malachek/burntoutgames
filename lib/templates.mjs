...
<section class="hero">
  ...
  <img class="hero__mark" src="/assets/logo/bog-logomark-outline.svg" alt="" aria-hidden="true">
    ...
    <ul class="team-grid">
      ${team.map((p) => {
        ...
        <div class="person__photo">${p.photo
          ...
          : `<div class="art-plate" style="${pat('spark-colorful')}"><img src="/assets/logo/bog-logomark-outline.svg" alt="" aria-hidden="true"></div>`}</div>
